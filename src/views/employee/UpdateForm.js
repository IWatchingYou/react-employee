...
export default class UpdateForm extends React.Component{
  ...
  handlerChange_ActivStat=(event)=>{
    this.setState({ active_stat: event.target.value })
  }
    ...
    if(this.validate_data() === true){
      ...
      setTimeout(()=>{
        ...
        const person = {
          ...
          active_stat: this.state.active_stat,
          contact_number: this.state.inputPhoneNumber,
          job_grade: this.state.inputJobGrade
        }
        
        axios.put(`${this.BASEURL}employees/${this.props.match.params.id}`, person)
        .then(res=>{
          if(this.state.statusImg === false || this.state.image == require('./users.jpeg')){
            this.handlerClick_Submit();
          }
          alert(`Now you update staff name ${person.name_eng}.`);
          console.log(res)
  ...
  personal(){
    axios.get(`${this.BASEURL}employees/${this.props.match.params.id}`)
    .then(res=>{
      const data = res.data.result;
      const dob = data.dob.split('-');
      const doj = data.date_join.split('-');
      this.setState({
        staff_code: data.staff_code,
        inputBranch: data.branch_code,
        inputEnglishName: data.name_eng,
        inputKhmerName: data.name_khm,
        gender: data.gender,
        marital: data.marital_status,
        inputBirthYear: dob[0],
        inputBirthMonth: dob[1],
        inputBirthDay: dob[2].substring(0, 2),
        inputLocation: data.location,
        inputDepartment: data.department,
        inputGroupPosition: data.group_position,
        inputPosition: data.position,
        inputJoinYear: doj[0],
        inputJoinMonth: doj[1],
        inputJoinDay: doj[2].substring(0, 2),
        inputDepartmentCode: data.department_code,
        inputLocationCode: data.location_code,
        inputEmail: data.email,
        active_stat: data.active_stat,
        inputPhoneNumber: data.contact_number,
        inputJobGrade: data.job_grade,
        image: 'http://app.chokchey.com:4000/static/'+data.staff_code+'.png'
      })
    })
        ...
        <form>
          <div className="row">
            <div className="col-md-3">
              ...
              <div className="card">
              <div className="card-body">
                  <h4 className="card-title">Satus Active</h4>
                  <div className="form-group">
                  <select className='form-control' value={this.state.active_stat} onChange={this.handlerChange_JobGrade}>
              ...
              <div className="card-body">
                  ...
                  <div className="form-group">
                    ...
                    <select value={this.state.inputJobGrade} className='form-control' onChange={this.handlerChange_JobGrade} hidden={this.state.inputJobGradeStatus === true ? false: true}>
                      {this.state.grade}
                    </select>
                  </div>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    ...
                    <select value={this.state.inputBranch} className='form-control' onChange={this.handlerChange_Branch} hidden={this.state.inputBranchstatus === true ? false: true}>
                      {this.state.branch}
                    </select>
                  </div>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    ...
                    <select value={this.state.inputLocationCode} className='form-control' onChange={this.handlerChange_Locationcode} hidden={this.state.inputLocationCodestatus === true ? false: true}>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    ...
                    <select value={this.state.inputLocation} className='form-control' onChange={this.handlerChange_Location} hidden={this.state.inputLocationstatus === true ? false: true}>
                      {this.state.location}
                    </select>
                  </div>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    ...
                    <select value={this.state.inputDepartmentCode} className='form-control' onChange={this.handlerChange_Departmentcode} hidden={this.state.inputDepartmentCodestatus === true ? false: true}>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    ...
                    <select value={this.state.inputDepartment} className='form-control' onChange={this.handlerChange_Department} hidden={this.state.inputDepartmentstatus === true ? false: true}>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    ...
                    <select value={this.state.inputGroupPosition} className='form-control' onChange={this.handlerChange_Groupposition} hidden={this.state.inputGroupPositionstatus === true ? false: true}>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    ...
                    <select value={this.state.inputPosition} className='form-control' onChange={this.handlerChange_Position} hidden={this.state.inputPositionstatus === true ? false: true}>
                      {this.state.position}
                    </select>
                  </div>
